...
<head>
    ...
    <title>Báo Tường Nụ Cười</title>
    <style>
        body {font-family: 'Arial', sans-serif;margin: 0; padding: 0; background-color: #f1f1f1;color: #333; }
        header {text-align: center;background-color: hotpink; padding: 30px; color: white;font-size: 60px;}
        ...
        h4{text-align: center;  font-size: 50px; }
    </style>
</head>
<body>
<header>
...
<div class="container">
    ...
    <div class="content">
        ...
        <ul>
            ...
            <li>Yêu quá đi thôi, tâm sáng ngời</li>

            <li>Chào đón bình minh đầy nắng mới</li>

            <li>Hồn nhiên thơ trẻ rất yêu đời.</li>
        </ul>
    </div>
    <div class="video">
    ...
    <div class="shmily">
      <h4>Những điều khiến bạn nở nụ cười có nằm trong điều dưới này không ?? điền vào cho mình  </h4>
      <p><input type="checkbox" name="lala" > Nhìn thấy cảnh đẹp</p>
      <p><input type="checkbox" name="chacha"> Được ăn ngon</p>
